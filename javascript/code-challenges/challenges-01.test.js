...
const addOne = (arr) => {
  const newArray = [];
  // Solution code here...
  arr.forEach(arrValue => newArray.push(arrValue + 1));
  return newArray;
};
...
const addExclamation = (arr) => {
  // Solution code here...
  const newEx = [];
  arr.forEach(exclamation => newEx.push(exclamation + '!'));
  return newEx;
};
...
const allUpperCase = (arr) => {
  // Solution code here...
  const upCase = [];
  arr.forEach(uppercase => upCase.push(uppercase.toUpperCase()));
  return upCase;
};
...
const speaker = (words, callback) => {
  // Solution code here...
  words.forEach(call => newGreet.push(callback(call)));
